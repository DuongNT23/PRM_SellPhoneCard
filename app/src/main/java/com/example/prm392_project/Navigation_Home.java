...
//        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        imgTru.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (x > 1) {
                    ...
                    Toast.makeText(Navigation_Home.this, "Số lượng phải lớn hơn 0", Toast.LENGTH_SHORT);
                }
            }
        });
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                if (item.getItemId() == R.id.contact) {
                    ...
                    i.putExtra("nameUser1", name);
                    startActivity(i);
                } else if (item.getItemId() == R.id.inforCard) {
                    //  Toast.makeText(Navigation_Home.this,"login is selected",Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(Navigation_Home.this, InforCard.class));
                }else if (item.getItemId() == R.id.register) {
                    //  Toast.makeText(Navigation_Home.this,"login is selected",Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(Navigation_Home.this, Register.class));
                } else if (item.getItemId() == R.id.map) {
                    //  Toast.makeText(Navigation_Home.this,"login is selected",Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(Navigation_Home.this, Map.class));
                } else if (item.getItemId() == R.id.feedback) {
                    //  Toast.makeText(Navigation_Home.this,"login is selected",Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(Navigation_Home.this, Feedback.class));
                }
        ...
        txt10.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // txt10.setTextColor(Color.RED);
                LoadColor();
                txt10.setBackgroundColor(Color.parseColor("#263377"));
                productID = 1;
            }
        });
        txt20.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // txt10.setTextColor(Color.RED);
                LoadColor();
                txt20.setBackgroundColor(Color.parseColor("#263377"));
                productID = 2;
            }
        });
        txt30.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // txt10.setTextColor(Color.RED);
                LoadColor();
                txt30.setBackgroundColor(Color.parseColor("#263377"));
                productID = 3;
            }
        });
        txt50.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // txt10.setTextColor(Color.RED);
                LoadColor();
                txt50.setBackgroundColor(Color.parseColor("#263377"));
                productID = 4;
            }
        });
        txt100.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // txt10.setTextColor(Color.RED);
                LoadColor();
                txt100.setBackgroundColor(Color.parseColor("#263377"));
                productID = 5;
            }
        });
        txt200.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // txt10.setTextColor(Color.RED);
                LoadColor();
                txt200.setBackgroundColor(Color.parseColor("#263377"));
                productID = 6;
            }
        });
        txt300.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // txt10.setTextColor(Color.RED);
                LoadColor();
                txt300.setBackgroundColor(Color.parseColor("#263377"));
                productID = 7;
            }
        });
        txt500.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // txt10.setTextColor(Color.RED);
                LoadColor();
                txt500.setBackgroundColor(Color.parseColor("#263377"));
                productID = 8;
            }
        });
        imgViettel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                LoadColorImg();
                imgViettel.setBackgroundColor(Color.parseColor("#263377"));
            }
        });
        imgMobiphone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                LoadColorImg();
                imgMobiphone.setBackgroundColor(Color.parseColor("#263377"));
            }
        });
        imgVinaphone.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                LoadColorImg();
                imgVinaphone.setBackgroundColor(Color.parseColor("#263377"));
            }
        });
        imgVietnammobile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                LoadColorImg();
                imgVietnammobile.setBackgroundColor(Color.parseColor("#263377"));
            }
        });
        btnMuangay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //User user = new User();
                String nameUser ="duong";
                Intent intent = getIntent();
                nameUser = intent.getStringExtra("nameUser");
                UserDAO userDAO ;
                userDAO = new UserDAO();

                int  sd = userDAO.getInforUser("duong").getBalance();
                if(nameUser==null){
                    if( userDAO.getInforUser("duong").getBalance()<=0){
                        Toast.makeText(Navigation_Home.this,"So du cua ban khong du",Toast.LENGTH_SHORT).show();
                    }else{
                        StorageDAO storageDAO = new StorageDAO();
                     //   String a = storageDAO.MuaNgay(x, productID).getSerialNumber();
                    }
                }else{
                    if( userDAO.getInforUser(nameUser).getBalance()<=0){
                        Toast.makeText(Navigation_Home.this,"So du cua ban khong du",Toast.LENGTH_SHORT).show();
                    }else{
                        StorageDAO storageDAO = new StorageDAO();
                        Intent intent2= new Intent(Navigation_Home.this, InforCard.class);
                        intent2.putExtra("sl",x);
                        intent2.putExtra("productId",productID);
                        startActivity(intent2);
                       // String a = storageDAO.MuaNgay(x, productID).getSerialNumber();
                        Toast.makeText(Navigation_Home.this,"Mua thanh cong ",Toast.LENGTH_SHORT).show();
...
//                storage.getSerialNumber();
    ...
    void LoadColorImg() {
        imgViettel.setBackgroundColor(Color.parseColor("#FFFFFF"));
        imgMobiphone.setBackgroundColor(Color.parseColor("#FFFFFF"));
        imgVietnammobile.setBackgroundColor(Color.parseColor("#FFFFFF"));
        imgVinaphone.setBackgroundColor(Color.parseColor("#FFFFFF"));
    }

    void LoadColor() {
        txt10.setBackgroundColor(Color.parseColor("#71BDAE"));
        txt20.setBackgroundColor(Color.parseColor("#71BDAE"));
        txt30.setBackgroundColor(Color.parseColor("#71BDAE"));
        txt50.setBackgroundColor(Color.parseColor("#71BDAE"));
        txt100.setBackgroundColor(Color.parseColor("#71BDAE"));
        txt200.setBackgroundColor(Color.parseColor("#71BDAE"));
        txt300.setBackgroundColor(Color.parseColor("#71BDAE"));
        txt500.setBackgroundColor(Color.parseColor("#71BDAE"));
    }
